...
(function (root) {
    ...
    function _scrypt(password, salt, N, r, p, dkLen, callback) {
      ...
      if (!ensureBuffer(password)) {
        throw new Error('password must be an array or buffer');
      }
      password = Array.prototype.slice.call(password);

      if (!ensureBuffer(salt)) {
      ...
      const _X = new Uint32Array(16);      // blockmixSalsa8
      ...
      // How many blockmixSalsa8 can we do per step?
    ...
    root.scrypt = function (password, salt, N, r, p, dkLen, progressCallback) {
